export const ONLINE_API_URL = process.env.NODE_ENV === 'production' ? 'http://35.246.233.49/api' : 'http://35.246.233.49:8080/api';
export const OFFLINE_API_URL = 'http://35.246.233.49:8081/api';
